            ...
            <section id="content">
                <div className="subpage">
                    ...
                    <div className="card-container">
                                    ...
                                    <div className="wings-box-item">
                                        <div className="wings-box-item-container">
                                            ...
                                            <div className="wings-box-item-content">
                                                ...
                                                <span className="wings-box-item-category">
                                                    ALIŞVERİŞ
                                                </span>
                                            </div>
                                        </div>
                        ...
                        <div className="endsoon-campaigns">
                            <div className="wings-box wings-box--logo-grey">
                                <h4>YAKINDA BİTECEK</h4>
                                <h2>KAMPANYALAR</h2>
                                <div className="row">
                                    <div className="wings-box-item">
                                        <div className="wings-box-item-container">
...
export default KartDetayKampanyalar;
