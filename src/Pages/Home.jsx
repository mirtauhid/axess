  ...
  <div className="search-container">
    <div className="search-close">
      <div className="container">
        <a href="/" className="search-close--button"><span className="icon-close2" /></a>
      </div>
    </div>
    <div className="search-content">
      ...
      <div className="most-searched-list">
        <div className="most-searched-list-item">
          ...
          <ul>
            <li><a href="/">Kart Başvurum Nerede</a></li>
            <li><a href="/">Otomatik Ödeme Talimatı</a></li>
            <li><a href="/">Kart Aidatları</a></li>
            <li><a href="/">Ekstreler</a></li>
            <li><a href="/">Kart Başvurum Nerede</a></li>
            <li><a href="/">Wings</a></li>
            <li><a href="/">Wings Black</a></li>
            <li><a href="/">Wings Premium</a></li>
            <li><a href="/">Otomatik Ödeme Talimatı</a></li>
            <li><a href="/">Sanal Kart</a></li>
          </ul>
        </div>
      </div>
      <div className="search-result-list">
        <div className="search-result-list-flex">
          ...
          <div className="search-result-list-item">
            ...
            <ul>
              <li><a href="/"><strong>Wings’e</strong> Özel Bodrum Aquapark’ta %10 İndirim</a></li>
              <li><a href="/"><strong>Wings’e</strong> Özel Bodrum Aquapark’ta %10 İndirim</a></li>
              <li><a href="/"><strong>Wings’e</strong> Özel Bodrum Aquapark’ta %10 İndirim</a></li>
              <li><a href="/"><strong>Wings’e</strong> Özel Bodrum Aquapark’ta %10 İndirim</a></li>
              <li><a href="/"><strong>Wings’e</strong> Özel Bodrum Aquapark’ta %10 İndirim</a></li>
        ...
        <div className="search-result-list-more">
          <a href="/"><strong>"Wings"</strong> için daha fazla sonuç gör <span className="icon-arrow" /></a>
        </div>
      </div>
    </div>
  </div>
  <header id="header">
    <div className="container">
      <div className="sub-header">
        <ul>
          <li>
            <a href="/"><span className="icon-card3" />Kart İşlemlerim</a>
          </li>
          <li>
            <a href="/"><span className="icon-search2" />Ara</a>
      ...
      <div className="header">
        ...
        <div className="logo">
          <a href="/"><img src="img/logo.svg" alt="Axess Wings" /></a>
        </div>
        <div className="mobile-search-btn">
          <a href="/"><span className="icon-search2" /></a>
            ...
            <li>
              ...
              <div className="mega-dropdown-container">
                <div className="mega-dropdown-content">
                  <div className="mega-dropdown-menu">
                    <div className="mega-dropdown-menu-item">
                      <h4>MİL PUAN</h4>
                      <ul>
                        <li><a href="/">Kaç mil puan kazanırım?</a></li>
                        <li><a href="/">Kaç mil puan kazanırım?</a></li>
                        <li><a href="/">Nasıl mil puan kazanırım?</a></li>
                        <li><a href="/">Mil puanları nerede kullanabilirim?</a></li>
                        <li><a href="/">Avans mil puan</a></li>
                      </ul>
                    </div>										
                  </div>
                  <div className="mega-dropdown-box">
                    <div className="dropdown-privileges-item">
                      <div className="dropdown-privileges-item-content">
                        <a href="/">100’DEN FAZLA <br />KAMPANYA
                ...
                <div className="mega-dropdown-info">
                  <a href="/">Mil puanlarla ilgili daha fazla bilgi almak için tıklayınız. <span className="icon-arrow" /></a>
                </div>
              </div>
            </li>
            <li><a href="/">AYRICALIKLAR</a></li>
            <li><a href="/">KAMPANYALAR</a></li>
            <li><a href="/">KARTLAR</a></li>
            <li><a href="/">BLOG</a></li>
          </ul>
          <a href="/" className="btn btn--bordered-yellow">AXESS MOBIL</a>
          <a href="/" className="btn btn--primary">HEMEN BAŞVUR</a>
        </div>
      </div>
    </div>
  </header>
  <section id="content">
      ...
      <div className="slider">
        <div className="slider-item">
          ...
          <div className="slider-content">
            ...
            <a href="/" className="btn btn--secondary">HEMEN BAŞVUR</a>
            <a href="/" className="btn btn--bordered-lightblue">DETAYLI BİLGİ</a>
          </div>
        </div>
      </div>
    ...
    <div className="campaign-container">
      <div className="wings-box wings-box--logo-grey">
        ...
        <a href="/" className="btn btn--bordered-blue">TÜM KAMPANYALAR</a>
      </div>
    </div>
    <div className="axess-app-container">
      ...
      <div className="axess-app">
        ...
        <div className="mobile-only-buttons">
          <a href="/" className="btn btn--secondary btn--icon btn--multiline"><span className="icon-info2" /><strong>App Store</strong>ile indir</a>
          <a href="/" className="btn btn--secondary btn--icon btn--multiline"><span className="icon-android" /><strong>Google play</strong>ile indir</a>
        </div>
        <div className="desktop-only-buttons">
          <a href="/" className="btn btn--secondary">AXESS MOBİL'İ İNDİR<span className="icon-info2" /><span className="icon-android" /></a>
          <a href="/" className="btn btn--bordered-lightblue">DETAYLI BİLGİ</a>
        </div>
      </div>
    </div>
    ...
    <div className="container">
      <div className="footer-menu">
        <div className="footer-menu-item">
          <h4><a href="/">KAMPANYALAR <span className="icon-arti" /> <span className="icon-sour" /></a></h4>
          <ul>
            <li><a href="/">Tüm Kampanyalar</a></li>
          </ul>
        </div>
        <div className="footer-menu-item active">
          <h4><a href="/">WINGS KART <span className="icon-arti" /> <span className="icon-sour" /></a></h4>
          <ul>
            <li><a href="/">Kart Özellikleri</a></li>
            <li><a href="/">Faiz ve Ücretler</a></li>
            <li><a href="/">Kampanyalar</a></li>
            <li><a href="/">Mil Puan</a></li>
            <li><a href="/">Merak Ettikleriniz</a></li>
          </ul>
        </div>
        <div className="footer-menu-item">
          <h4><a href="/">WINGS AYRICALIKLARI <span className="icon-arti" /> <span className="icon-sour" /></a></h4>
          <ul>
            <li><a href="/">Tüm Wings Ayrıcalıkları</a></li>
          </ul>
        </div>
        <div className="footer-menu-item">
          <h4><a href="/">MERAK ETTİKLERİNİZ <span className="icon-arti" /> <span className="icon-sour" /></a></h4>
          <ul>
            <li><a href="/">Sıkça Sorulanlar</a></li>
            <li><a href="/">Bankacılık İşlemleri</a></li>
            <li><a href="/">Faiz ve İşlem Ücretleri</a></li>
          </ul>
        </div>
        <div className="footer-menu-item">
          <h4><a href="/">MİL PROGRAMI <span className="icon-arti" /> <span className="icon-sour" /></a> </h4>
          <ul>
            <li><a href="/">Ne Kadar Mil Puan Kazanırım?</a></li>
            <li><a href="/">Ne Kadar Mil Puanım Var?</a></li>
            <li><a href="/">Nasıl Mil Puan Kazanırım?</a></li>
            <li><a href="/">Mil Puanları Nerede Kullanabilirm?</a></li>
            <li><a href="/">Avans Mil Puan</a></li>
          </ul>
        </div>
      </div>
      ...
      <div className="footer-bottom-menu">
        <ul>
          ...
          <li><a href="/">Web Sitesi Kullanıcı Sözleşmesi</a></li>
