      ...
      <div className="card-container">
                      ...
                      <dd style={{display: 'block'}}>
                        <div className="interest-and-fees-table">
                          <div className="interest-and-fees">
                            <div className="interest-and-fees-item">Kart Tipi</div>
                            <div className="interest-and-fees-item">Wings</div>
                            <div className="interest-and-fees-item">Wings Business</div>
                          </div>
                          <div className="interest-and-fees">
                            <div className="interest-and-fees-item">Asıl Kart</div>
                            <div className="interest-and-fees-item">124 TL</div>
                            <div className="interest-and-fees-item">195 TL</div>
                          </div>
                          <div className="interest-and-fees">
                            <div className="interest-and-fees-item">Ek Kart</div>
                            <div className="interest-and-fees-item">62 TL</div>
                            <div className="interest-and-fees-item">-</div>
                          </div>
                        </div>
                      </dd>
                    </dl>
                    <blockquote>* Kart ücretlerine BSMV dahildir. Wings kartların yıllık ücreti ilk kullanımınızı takip eden 1. ayda hesap özetinize yansıtılır. Kart ücretleri 01.03.2018 tarihinde güncellenmiştir.</blockquote>
                    <dl className="accordion-box">
        ...
        <div className="card-details">
          <div className="container">
            <div className="row">
              <div className="col-lg-8 offset-lg-2">
                <h4>Kampanya Katılım SMS Ücretleri</h4>
                <p>5990’a kısa mesaj gönderilerek katılım sağlanan kampanyalara tüm operatör aboneleri katılabilir.
                  SMS tutarı, KDV ve ÖİV dahil olmak üzere;Turkcell, Vodafone ve Türk Telekom aboneleri için 0,65TL olarak ücretlendirilir.Turkcell, Vodafone ve Türk Telekom kısa mesaj birim fiyatlarında meydana gelebilecek değişiklikleri yansıtma hakkını saklı tutar.</p>
                <p>5990’a kısa mesaj gönderilerek katılım sağlanan kampanyalara tüm operatör aboneleri katılabilir.
                  SMS tutarı, KDV ve ÖİV dahil olmak üzere;Turkcell, Vodafone ve Türk Telekom aboneleri için 0,65TL olarak ücretlendirilir.Turkcell, Vodafone ve Türk Telekom kısa mesaj birim fiyatlarında meydana gelebilecek değişiklikleri yansıtma hakkını saklı tutar.</p>
                <p>5990’a kısa mesaj gönderilerek katılım sağlanan kampanyalara tüm operatör aboneleri katılabilir.
                  SMS tutarı, KDV ve ÖİV dahil olmak üzere;Turkcell, Vodafone ve Türk Telekom aboneleri için 0,65TL olarak ücretlendirilir.Turkcell, Vodafone ve Türk Telekom kısa mesaj birim fiyatlarında meydana gelebilecek değişiklikleri yansıtma hakkını saklı tutar.</p>
                <dl className="accordion">
                  <dt>Taksitli Borç Transferi</dt>
                  <dd>
                    <p>Wings’le biriktirdiğiniz Mil Puan’ları 444 25 25 Akbank Telefon Şubesi’ni arayarak uçak bileti almak için veya GezKanatlan.com üzerinden uçak bileti, otel konaklaması, tur, gemi turu ve seyahat sigortası almak için kullanabilirsiniz. Ayrıca isterseniz Mil Puan’larınızı anlaşmalı Wings Style üye işyerlerinde de kullanabilirsiniz. Wings Mil Programında kontenjan sınırı, sezon farkı ve havayolu kısıtlaması yoktur.</p>
                  </dd>
                  <dt>Diğer Ürünler</dt>
                  <dd>
                    <p>Wings’le biriktirdiğiniz Mil Puan’ları 444 25 25 Akbank Telefon Şubesi’ni arayarak uçak bileti almak için veya GezKanatlan.com üzerinden uçak bileti, otel konaklaması, tur, gemi turu ve seyahat sigortası almak için kullanabilirsiniz. Ayrıca isterseniz Mil Puan’larınızı anlaşmalı Wings Style üye işyerlerinde de kullanabilirsiniz. Wings Mil Programında kontenjan sınırı, sezon farkı ve havayolu kısıtlaması yoktur.</p>
                ...
                <h4>Wing Üyelik Sözleşmesi</h4>
                <h5>Sözleşmeler</h5>
                <p>Wings kredi kartı sözleşmelerini yürürlüğe girme tarihleri ile aşağıda bulabilirsiniz.</p>
                <div className="download-documents">
                  <ul>
                    <li><a href="javascript:;">Kredi Kartları Hizmet Sözleşmesi - 13.01.2017</a></li>
                    <li><a href="javascript:;">Kredi Kartları Hizmet Sözleşmesi - 13.01.2017</a></li>
                    <li><a href="javascript:;">Kredi Kartları Hizmet Sözleşmesi - 13.01.2017</a></li>
                    <li><a href="javascript:;">Kredi Kartları Hizmet Sözleşmesi - 13.01.2017</a></li>
                    <li><a href="javascript:;">Kredi Kartları Hizmet Sözleşmesi - 13.01.2017</a></li>
