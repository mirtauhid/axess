                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-lg-8 offset-lg-2">
                                        ...
                                        <p>
                                            5990’a kısa mesaj gönderilerek katılım sağlanan
                                            kampanyalara tüm operatör aboneleri katılabilir. SMS
                                            tutarı, KDV ve ÖİV dahil olmak üzere;Turkcell, Vodafone
                                            ve Türk Telekom aboneleri için 0,65TL olarak
                                            ücretlendirilir.Turkcell, Vodafone ve Türk Telekom kısa
                                            mesaj birim fiyatlarında meydana gelebilecek
                                            değişiklikleri yansıtma hakkını saklı tutar.
                                        </p>
                                        <p>
                                            5990’a kısa mesaj gönderilerek katılım sağlanan
                                            kampanyalara tüm operatör aboneleri katılabilir. SMS
                                        ...
                                        <dl className="accordion">
                                            ...
                                            <dd>
                                                <p>
                                                    Wings’le biriktirdiğiniz Mil Puan’ları 444 25 25
                                                    Akbank Telefon Şubesi’ni arayarak uçak bileti
                                                    almak için veya GezKanatlan.com üzerinden uçak
                                                    bileti, otel konaklaması, tur, gemi turu ve
                                                    seyahat sigortası almak için kullanabilirsiniz.
                                                    Ayrıca isterseniz Mil Puan’larınızı anlaşmalı
                                                    Wings Style üye işyerlerinde de
                                                    kullanabilirsiniz. Wings Mil Programında
                                                    kontenjan sınırı, sezon farkı ve havayolu
                                                    kısıtlaması yoktur.
                                                </p>
                                            </dd>
                                            <dt>Diğer Ürünler</dt>
                                        ...
                                        <h5>Sözleşmeler</h5>
                                        <p>
                                            Wings kredi kartı sözleşmelerini yürürlüğe girme
                                            tarihleri ile aşağıda bulabilirsiniz.
                                        </p>
                                        <div className="download-documents">
                                            <ul>
                                                <li>
                                                    <a href="/">
                                                        Kredi Kartları Hizmet Sözleşmesi -
                                                        13.01.2017
                                                    </a>
                                                </li>
                                                <li>
