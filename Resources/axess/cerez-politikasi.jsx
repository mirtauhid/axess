      ...
      <div className="subpage-container">
        <div className="row">
          <div className="col-lg-8 offset-lg-2">
            ...
            <p>Gizliliğiniz bizim için önemlidir, gizlilik ve güvenlik haklarınız temel prensibimizdir. Müşterilerimizin kişisel bilgilerinin gizliliğini korumak amacıyla bankamız sistem ve internet altyapısı en güvenilir seviyede tutularak gerekli önlemler alınmıştır.</p>
            <p>Web sitemize şahsi herhangi bir bilgi vermeden ziyaret edebilir, ürünlerimiz ve servislerimiz hakkında bilgi alarak ihtiyaçlarınızı karşılayabilirsiniz. Ziyaretlerde site kullanımına ilişkin bilgi toplamak için çerez kullanılmaktadır. Buradaki amacımız; web sitemizi ziyaret eden kullanıcıya kolaylık sağlamak ve işleyişi daha iyiye nasıl taşıyabileceğimizi anlamaktır.</p>
            ...
            <p>Geçerlilik sürelerine göre Kalıcı Çerez ve Geçici Çerez olarak iki çerez tipi bulunmaktadır. Geçici çerezler internet sitesini ziyaret ettiğiniz esnada oluşturulur ve sadece tarayıcınızı kapatıncaya kadar geçerlidirler. Kalıcı çerezler ise internet sitesini ziyaret ettiğinizde oluşturulur ve siz silinceye veya süreleri doluncaya kadar kalırlar. Ayarlarınız ile uyumlu kişiselleştirilmiş bir deneyim sunma gibi işlemler yapmak için kalıcı çerezler kullanılırlar.</p>
            <p>Web sitemiz geçici ve kalıcı tip çerezleri, sizi web sitemizin diğer kullanıcılarından ayırt etmek ilgi alanlarınıza ve tercihlerinize göre düzenleme yapmak için kullanılmaktadır. Akbank tarafından tasarlanmış çerezlerin yanı sıra üçüncü taraflardan alınan hizmetler kapsamında da çerez kullanılabilmektedir.</p>
            <p>Hemen hemen tüm internet tarayıcıları, çerezleri otomatik olarak kabul edecek şekilde ön tanımlıdır. Ancak çerezleri dilediğiniz gibi kontrol edebilir veya silebilirsiniz. Çerezleri yönetmek tarayıcıdan tarayıcıya farklılık gösterdiğinden ayrıntılı bilgi almak için tarayıcının yardım menüsüne bakılabilirsiniz.</p>
            <h4>Çerez nedir?</h4>
            <p>Çerez, bir siteyi ziyaret ettiğinizde sitenin bilgisayarınıza veya mobil cihazınıza kaydettiği küçük boyutlu bir metin dosyasıdır. Çerezler bir web sitesinin çalışması veya daha verimli çalışması veya web sitesinin sahiplerine bilgi sağlamak için yaygın olarak kullanılmaktadır.</p>
            <h4>Çerezleri nasıl kullanıyoruz?</h4>
            <p>Bilgisayarınıza yüklenen çerezler veya elde edilen bilgiler istatiksel analizler veya güvenlik önlemleri için kullanılmaktadır. Herhangi bir kişisel veriniz çerezler aracılığı ile toplanmamaktadır.</p>
            <h4>Çerezleri nasıl kontrol edebilirsiniz?</h4>
            <p>Çerezleri dilediğiniz gibi kontrol edebilir veya silebilirsiniz. Bilgisayarınızda halihazırda bulunan çerezleri silebilir ve çoğu Internet gezgininde çerez kaydedilmesini/yerleştirilmesini engelleyebilirsiniz.</p>
            ...
            <p>Çerezleri silmeyi tercih ederseniz ilgili web sitesindeki tercihleriniz silinecektir. Ayrıca, çerezleri tamamen engellemeyi tercih ederseniz Akbank’a ait web siteleri dahil olmak üzere birçok web sitesi düzgün çalışmayabilir.</p>
          </div>
        </div>
      </div>
    </div>		
