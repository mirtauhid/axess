    ...
    <div className="subpage">
      <div className="hero-area-container">
        ...
        <div className="hero-area">
          <h1><span>SIKÇA SORULAN</span> SORULAR</h1>
        </div>
      </div>
          ...
          <div className="col-lg-8 offset-lg-2">
            <dl className="accordion">
              ...
              <dd style={{display: 'block'}}>
                <p>Wings Mil Programında alışverişlerden Mil Puan kazanılır, Axes Üye işyerlerinden hem Mil Puan, hem de chip-para kazanılır. Mil Puan’larla istenilen havayoluyla, istenilen yere, kontenjan kısıtlaması olmadan ve alan vergisi ödemeden bedava bilet alınabilir. Her ay biriken chip-paralar otomatik olarak Mil Puan'a dönüşür, daha hızlı Mil Puan biriktirilir.</p>
              </dd>
