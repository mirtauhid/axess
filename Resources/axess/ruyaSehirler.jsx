...
const ruyaSehirler = () => {
  ...
  <section id="content" className="light-template">
    <div className="subpage">
      <div className="hero-area-banner-container dream-cities">
        <div className="hero-area-banner">
          <div className="hero-area-banner-content">
            <h1>RÜYA ŞEHİRLER</h1>
            <p>Rüya Şehir için biletinizi Wings ile 444 25 25<br /> Akbank Telefon Şubesi üzerinden hafta içi<br /> 09:00-18:00 saatleri arasında satın alabilirsiniz.</p>
          </div>
        </div>
      </div>
      <div className="hero-area-box-menu-container">
        <div className="row">
          <div className="hero-area-box-menu-item">
            <a className="hero-area-box-menu-content" href="javascript:;">
              <div className="hero-area-box-menu-image">
                <img src="img/ruya-sehirler-1.jpg" />
              </div>
              <div className="hero-area-box-menu-title">İstanbul</div>
            </a>
          </div>
          <div className="hero-area-box-menu-item">
            <a className="hero-area-box-menu-content" href="javascript:;">
              <div className="hero-area-box-menu-image">
                <img src="img/ruya-sehirler-2.jpg" />
              </div>
              <div className="hero-area-box-menu-title">Kayseri</div>
            </a>
          </div>
          <div className="hero-area-box-menu-item">
            <a className="hero-area-box-menu-content" href="javascript:;">
              ...
              <div className="hero-area-box-menu-title">Erzurum</div>
            </a>
          </div>
        </div>
      </div>
