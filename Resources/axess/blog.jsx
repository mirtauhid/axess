      ...
      <div className="hero-area-container blog-hero-area">
        ...
        <div className="hero-area">
          ...
          <div className="blog-search-area">
            ...
            <button type="button"><span className="icon-search2" /></button>
          </div>
        </div>
      </div>
      <div className="blog-menu">
        <ul>
          <li className="active"><a href="javascript:;"><span className="icon-tumu" />Tümü</a></li>
          <li><a href="javascript:;"><span className="icon-fly2" />Seyahat</a></li>
          <li><a href="javascript:;"><span className="icon-gurme" />Gurme</a></li>
          <li><a href="javascript:;"><span className="icon-like" />Sağlık</a></li>
          <li><a href="javascript:;"><span className="icon-smile" />Yaşam</a></li>
          <li><a href="javascript:;"><span className="icon-filtre" />Video Galeri</a></li>
        </ul>
      </div>
          ...
          <div className="row">
            <div className="col-12 col-lg-8">
              <div className="secondary-blog-item secondary-blog-item--highlight">
                ...
                <div className="secondary-blog-details">
                  ...
                  <p>Lorem ipsum dolor sit amet dolores
                    no preblama so uno loraine. Lorem
                    ipsum dolor sit amet dolores no preb
                    lama so uno loraine. Lorem ipsum
                    dolor sit amet.</p>
                </div>
              </div>
            </div>
            <div className="col-12 col-lg-4">
              <div className="secondary-blog-item">
                <div className="secondary-blog-image">
                  <img src="img/secondary-blog.jpg" />
                  <span className="blog-category" style={{backgroundColor: '#50802d'}}>DÜNYA</span>
                </div>
                <div className="secondary-blog-details">
                  <h3>Doğanın Eşsiz Harikaları Norveç Fiyortları</h3>
                  <p>Lorem ipsum dolor sit amet dolores no preblama so uno loraine.</p>
                </div>
            ...
            <div className="col-12 col-lg-4">
              <div className="secondary-blog-item">
                <div className="secondary-blog-image">
                  <img src="img/secondary-blog.jpg" />
                  <span className="blog-category" style={{backgroundColor: '#cf7148'}}>ŞEREFLERDEN TARİFLER</span>
                </div>
                <div className="secondary-blog-details">
                  <h3>Doğanın Eşsiz Harikaları Norveç Fiyortları</h3>
                  <p>Lorem ipsum dolor sit amet dolores no preblama so uno loraine.</p>
