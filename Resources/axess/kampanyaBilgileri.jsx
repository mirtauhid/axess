        ...
        <div className="privileges-details">
          <div className="row">
            ...
            <div className="privileges-detail-content">
              ...
              <a href="javascript:;" className="btn btn--secondary btn--bordered-yellow">AXESS MOBİL'İ İNDİR<span className="icon-info2" /><span className="icon-android" /></a>
            </div>
          </div>
        </div>
        <div className="container-mobile">
          <div className="tab-container">
            <div className="tab-item active">
              <a href="javascript:;">Kampanya Bilgileri</a>
            </div>
            <div className="tab-item">
              <a href="javascript:;">Kampanya Detayları</a>
            </div>
            <div className="tab-item">
              <a href="javascript:;">Geçerli Olduğu Yerler</a>
            </div>
          </div>
            ...
            <div className="tab-detail-item">
              <div className="privileges-info">
                <div className="privileges-info-item">
                  ...
                  <h3>KAMPANYA GEÇERLİLİK Tarİhİ</h3>
                  <p>01.01.2020 - 31.12.2020</p>
                </div>
                <div className="privileges-info-item">
                  <span className="icon-profile" />
                  <h3>KİMLER KATILABİLİR</h3>
                  <p>Axess Mobil üzerinden<br /> giris yapan tüm Wings<br /> Card sahipleri.</p>
                </div>
                <div className="privileges-info-item">
                  <span className="icon-card" />
                  <h3>GEÇERLİ KARTLAR</h3>
                  <p>Wings<br />
                    Wings Business<br />
                    Wings Black<br />
                    Wings Private</p>
...
export default kampanyaBilgileri;