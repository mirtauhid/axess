    ...
    <div className="subpage">
      <div className="subpage-secondary-blog-container">
        ...
        <div className="subpage-secondary-blog-content">
          <h1>Akdeniz'deki Karayip Adası: <br />İbiza</h1>
          <p>Eğlence adası olarak bilinen İbiza adasına hem deniz turizmi için hem de doğal güzellikleri görmek için buraya her yıl çok sayıda kişi akın ediyor.</p>
          <div className="inline-tab-container">
            <div className="inline-tab-container-scroll">
              <div className="inline-tab-item active">
                <a href="javascript:;">Nerede Kalınır?</a>
              </div>
              <div className="inline-tab-item">
                <a href="javascript:;">Ne Yenilir?</a>
              </div>
              <div className="inline-tab-item">
                <a href="javascript:;">Gece Hayatı</a>
              </div>
              <div className="inline-tab-item">
                <a href="javascript:;">Ne Yapılır?</a>
              </div>
            </div>
          </div>
          <h3>Hotel Haciende Na Xamena</h3>
          <p>Merkeze 20 dakika uzaklıktaki Haciende Na Xamena, dağların arasında bir koydaki lokasyonuyla tam bir cep cenneti ve diğer tüm İbiza otelleri arasında hop diye sıyrılıveriyor. 75 odasının çoğu bu muhteşem koya tepeden bakan bir manzaraya sahip. Odaların çoğunda mini birer havuz sayılabilecek jakuzi, bir kısmında da özel hamam ve sauna bulunuyor. Otelin spa’sı La Posidonia’nın antik ortamında masaj ve terapi seçenekleri var fakat önce Cascadas Suspenidas’a gitmek şart! İbiza’da görüleceklerle dolu otel binasının biraz yukarısında travertenler gibi basamak basamak inen bu havuz, ufukta masmavi denizle birleşerek muhteşem bir görüntü oluşturuyor. Ayrı havuzcuklardan oluşan bu büyük havuzun suyu ısıtılıyor.</p>
          ...
          <div className="mil-point-container">
            ...
            <a href="javascript:;" className="btn btn--secondary">MİL PUAN SORGULA</a>
          </div>
          <h3>Ibiza Corso</h3>
          <p>Corso sadece konumuyla bile ilgiyi hak ediyor. İbiza’da eğlence merkezi olan marinaya, restoranlara ve alışveriş noktalarına oldukça yakın. Yakın zamanda yenilendiği için çağdaş bir görünüme sahip. Odaların büyüklükleri dışında birbirinden stil olarak pek farkı yok. Açık ve kapalı havuzların her ikisi de marinaya bakıyor ve oldukça keyifli bir atmosfer sunuyor. Spa’sı ve spor salonunda da işinin ehli bir ekip sizi şımartmak için bekliyor. Otelin bir restoranı yok ancak oldukça hareketli bir gece kulübü var.</p>
          <div className="subpage-secondary-blog-image">
            <img src="img/blog-detay-2.jpg" />
          </div>
          <h3>Atzaro</h3>
          <p>Uzun yıllardır aynı aile tarafından yönetilen otel, İbiza’nın en ünlü otellerinden biri. Eski bir çiftlik evinden otele dönüştürülen yapı, 24 odasıyla hizmet veriyor. Portakal bahçelerinin içindeki ev, yüksek kemerli geçişleri, beyaz perdelerin uçuştuğu, ahşap oymalı dekoruyla etrafındaki doğal yapıyla uyumlu dingin bir ortam yaratıyor. Tipik birer köy evi gibi tasarlanmış ve antikalarla dekore edilmiş odalar İbiza’da nerede kalınır diye endişelenenler için ideal. Kahvaltı, öğle ve akşam yemeği için ayrı menüler sunan otelin bunlara ek olarak bir sushi barı, hatırı sayılır bir şarap mahzeni ve bir puro koleksiyonu bulunuyor. Küçük bir butik otel olmasına rağmen hiçbir servisi eksik bırakmamışlar. Özel hocalardan pilates, yoga ve meditasyon dersleri almak da yine İbiza’da yapılacaklardan.</p>
          <div className="subpage-secondary-blog-image">
            <img src="img/blog-detay-3.jpg" />
          </div>
          <h3>Hotel Mirador de Dalt Vila</h3>
          <p>Otel, UNESCO’nun korumaya aldığı, denizden oldukça yüksek, etrafı duvarlarla çevrili, İbiza’da mutlaka görülmesi gereken tarihi bir şehir merkezi olan Dalt Vila’da bulunuyor. Bir zamanlar varlıklı bir ailenin evi olan bina, otel olarak restore edilirken, binanın tarihi yapısı ve planları göz önünde bulundurulmuş ve orijinal yapı korunmuş. Uçuk kaçık tasarım otellerde rahat edemeyen, klasik bildiğimiz otel odalarını arayanlar için ideal bir seçim. Üstelik 13 odasıyla çok daha samimi ve rahat bir atmosferi var. Mümkünse Grand Suit’i ayırtın. Kendisi bu İbiza otelinin hem en şık, hem de en lüks odası. Otel düşük kalorili sağlıklı kahvaltıları, zarif restoranı Es Mirador, şarap mahzeni ve kokteyl barıyla gerçekten hoş bir konaklama sunuyor.</p>
          <div className="subpage-secondary-blog-image">
      ...
      <div className="blog-container">
        <div className="blog">
          ...
          <a href="javascript:;" className="btn btn--bordered-blue">TÜM BLOG YAZILARI</a>
        </div>
      </div>
    </div>	
  </section>
