              ...
              <div className="places">
                ...
                <div className="places-item">
                  <div className="places-header">
                    ...
                    <div className="working-hours">Mağazalarımız, saat <strong>10:00</strong> ile <strong>21:00</strong> saatleri arasında açıktır.</div>
                  </div>
                  <div className="places-address">
                    <a href="javascript:;">Balmumcu, Barbaros Blv. No:1, 34330, Balmumcu, Barbaros Blv. No:1, 34330<br />Beşiktaş/İstanbul</a>
                  </div>
                </div>
                <div className="places-item">
                  <div className="places-header">
