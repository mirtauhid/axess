    ...
    <div className="subpage">
      <div className="hero-area-container">
        ...
        <div className="hero-area">
          <h1>KAMPANYALAR</h1>
          <ul>
            <li><a href="javascript:;">AXESS MOBİLE ÖZEL</a></li>
            <li><a href="javascript:;">EKSTRA - MİL PUAN</a></li>
            <li><a href="javascript:;">TAKSİT</a></li>
            <li><a href="javascript:;">İNDİRİM</a></li>
            <li><a href="javascript:;">2 KAT MİL PUAN</a></li>
            <li><a href="javascript:;">RÜYA ŞEHİRLER</a></li>
            <li><a href="javascript:;">ZİBUZİ</a></li>
            <li><a href="javascript:;">CHIP - PARA</a></li>
            <li><a href="javascript:;">NAKİT İHTİYAÇLARI</a></li>
            <li><a href="javascript:;">TÜMÜ</a></li>
          </ul>
        </div>
      </div>
      <div className="privileges-list">
        <div className="privileges-list-filter">
          ...
          <div className="privileges-filter-result">128 adet sonuç gösterilmektedir.</div>
        </div>
        <div className="wings-box wings-box--logo-grey">
              ...
              <div className="wings-box-item-container">
                <div className="wings-box-item-image">
                  <a href="javascript:;">
                    ...
                    <div className="wings-box-special">Axess Mobile Özel</div>
                ...
                <div className="wings-box-campaign-over">
                  <div className="wings-box-campaign-over-text"><span className="icon-warning"><span className="path1" /><span className="path2" /></span>Bu kampanya sona ermiştir.</div>
                </div>
              </div>
            </div>
            <div className="wings-box-item">
          ...
          <div className="show-more">
            <a href="javascript:;" className="btn--inline">DAHA FAZLA AYRICALIK GÖSTER</a>
          </div>
        </div>
      </div>
