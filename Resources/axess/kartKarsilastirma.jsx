          ...
          <div className="card-comparison-container">
            <div className="card-comparion-mobile-scroll">
              <div className="card-comparison-row">
                ...
                <div className="card-comparison-column">
                  <div className="card-comparison-column-title">Wings Card</div>
                  <div className="card-comparison-column-image">
                    <img src="img/wings-card-01.png" />
                  </div>
                  <a href="javascript:;" className="card-comparison-column-link">DETAYLI BİLGİ</a>
                </div>
                <div className="card-comparison-column">
                  <div className="card-comparison-column-title">Wings Black</div>
                  <div className="card-comparison-column-image">
                ...
                <div className="card-comparison-column">
                  <div className="card-comparison-column-title">Wings Private</div>
                  <div className="card-comparison-column-image">
              ...
              <div className="card-comparison-row">
                ...
                <div className="card-comparison-column" data-label="Avans Mil">Max. 100.000 Mil</div>
                <div className="card-comparison-column" data-label="Avans Mil">Max. 200.000 Mil</div>
                <div className="card-comparison-column" data-label="Avans Mil">Max. 300.000 Mil</div>
              </div>
              <div className="card-comparison-row">
                <div className="card-comparison-column">Seyehat / Restoran ve Yurt Dışında Ekstra Mil Kazanımı</div>
                <div className="card-comparison-column" data-label="Seyehat / Restoran ve Yurt Dışında Ekstra Mil Kazanımı">%15</div>
                <div className="card-comparison-column" data-label="Seyehat / Restoran ve Yurt Dışında Ekstra Mil Kazanımı">%30</div>
                <div className="card-comparison-column" data-label="Seyehat / Restoran ve Yurt Dışında Ekstra Mil Kazanımı">%40</div>
              </div>
              <div className="card-comparison-row">
                <div className="card-comparison-column">Seyahat Hizmetleri</div>
                <div className="card-comparison-column" data-label="Seyahat Hizmetleri"><span className="icon-tick-2" /></div>
                <div className="card-comparison-column" data-label="Seyahat Hizmetleri"><span className="icon-tick-2" /></div>
                <div className="card-comparison-column" data-label="Seyahat Hizmetleri"><span className="icon-tick-2" /></div>
              </div>
              <div className="card-comparison-row">
                <div className="card-comparison-column">Seyahat Sağlık Sigortası</div>
                <div className="card-comparison-column" data-label="Seyahat Sağlık Sigortası">Yurt içinde geçerli</div>
                <div className="card-comparison-column" data-label="Seyahat Sağlık Sigortası">Yurt içinde geçerli</div>
                <div className="card-comparison-column" data-label="Seyahat Sağlık Sigortası">Yurt içi ve yurt dışında geçerli</div>
              </div>
              <div className="card-comparison-row">
                <div className="card-comparison-column">Havalimanında İndirimli Vale Parking</div>
                <div className="card-comparison-column" data-label="Havalimanında İndirimli Vale Parking"><span className="icon-cross" /></div>
                <div className="card-comparison-column" data-label="Havalimanında İndirimli Vale Parking"><span className="icon-tick-2" /></div>
                <div className="card-comparison-column" data-label="Havalimanında İndirimli Vale Parking"><span className="icon-tick-2" /></div>
              </div>
              <div className="card-comparison-row">
                <div className="card-comparison-column">Araç Kiralama Sigortası</div>
                <div className="card-comparison-column" data-label="Araç Kiralama Sigortası"><span className="icon-tick-2" /></div>
                <div className="card-comparison-column" data-label="Araç Kiralama Sigortası"><span className="icon-tick-2" /></div>
                <div className="card-comparison-column" data-label="Araç Kiralama Sigortası"><span className="icon-tick-2" /></div>
              </div>
              <div className="card-comparison-row">
                <div className="card-comparison-column">Lounge Giriş Hizmeti</div>
                <div className="card-comparison-column" data-label="Lounge Giriş Hizmeti"><span className="icon-cross" /></div>
                <div className="card-comparison-column" data-label="Lounge Giriş Hizmeti"><span className="icon-cross" /></div>
                <div className="card-comparison-column" data-label="Lounge Giriş Hizmeti"><span className="icon-tick-2" /></div>
              </div>
            </div>
          </div>
        </div>
