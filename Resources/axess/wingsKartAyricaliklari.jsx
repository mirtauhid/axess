        ...
        <div className="container-mobile">
          ...
          <div className="tab-detail-container">
            <div className="tab-detail-item">
              <h2>NE KADAR MİL PUAN KAZANIRIM?</h2>
              <div className="row box-info-container">
                <div className="box-info-item">
                  <div className="box-info-item-content">
                    <span className="icon-memeber-business" />
                    <p>Axess Üye İşyerlerinden yaptığınız alışverişlerden chip-para da biriktirirsiniz.</p>
                  </div>
                </div>
                <div className="box-info-item">
                  <div className="box-info-item-content">
                    <span className="icon-vale" />
                    <p>Zorlu Center’da ücretsiz vale hizmetlerinden yararlanabilirsiniz.</p>
                  </div>
                </div>
                <div className="box-info-item">
                  <div className="box-info-item-content">
                    <span className="icon-shopping" />
                    <p>Yüzlerce marka ve restoranda indirimlerden faydalanabilirsiniz.</p>
                  </div>
                </div>
                <div className="box-info-item">
                  <div className="box-info-item-content">
                    <span className="icon-fly" />
                    <p>Yurt içinde ve yurt dışında yaptığınız alışverişlerden Mil Puan kazanırsınız.</p>
                  </div>
                </div>
                <div className="box-info-item">
                  <div className="box-info-item-content">
                    <span className="icon-transfer" />
                    <p>Konforlu havaalanı transferi ayrıcalığı ile seyehatlerinizi daha rahat gerçekleştirirsiniz.</p>
                  </div>
                </div>
                <div className="box-info-item">
                  <div className="box-info-item-content">
                    <span className="icon-location" />
                    <p>Lokasyona özel teklifler ile hayatı ayrıcalıklı yaşarsınız.</p>
                  </div>
                </div>
              </div>
            </div>
