            ...
            <section id="content">
                <div className="subpage">
                    <div className="subpage-content">
                        <div className="wings-box-campaign-over-detail">
                            <div className="wings-box-campaign-over-detail-text">
...
export default KampanyaSonaErdiDetay;
